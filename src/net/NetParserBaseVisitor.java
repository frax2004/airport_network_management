...
/**
 * This class provides an empty implementation of {@link NetParserVisitor},
...
public class NetParserBaseVisitor<T> extends AbstractParseTreeVisitor<T> implements NetParserVisitor<T> {
	/**
	 * {@inheritDoc}
	 *
